...
/** @type {string} */
const CACHE_VERSION = '1781415662|987997701';
/** @type {string} */
const CACHE_PREFIX = 'f1-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'F1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["F1.html","F1.js","F1.offline.html","F1.icon.png","F1.apple-touch-icon.png","F1.audio.worklet.js","F1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["F1.wasm","F1.pck","F1.side.wasm"];
